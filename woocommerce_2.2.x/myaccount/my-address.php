...
if ( !yit_woocommerce_default_shiptobilling_only() ) {
...
<?php if ( !yit_woocommerce_default_shiptobilling_only() ) echo '<div class="col2-set addresses">'; ?>
...
<?php if ( !yit_woocommerce_default_shiptobilling_only() ) echo '</div>'; ?>