            ...
            <td>
                ...
                if ( $woocommerce->cart->tax_display_cart == 'incl' ) {
                    ...
                    if ( ! empty( $tax_string_array ) ) {
                        ?><small class="includes_tax"><?php printf( __( '(Includes %s)', 'yit' ), implode( ', ', $tax_string_array ) ); ?></small><?php
                    }
                }
                ?>
            </td>
    ...
    <div id="payment">
        ...
        <div class="form-row place-order">
            ...
            <div class="checkout_buttons">
                <input type="button" value="&larr; <?php _e('Customer Details', 'yit') ?>" class="prev button" data-step="2" />
                <?php echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' ); ?>
            </div>
            <?php else : ?>
                <?php echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="red-button alt" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' ); ?>
            <?php endif ?>

            <?php if (woocommerce_get_page_id('terms')>0) : ?>
                <p class="form-row terms">
                    <label for="terms" class="checkbox"><?php _e( 'I have read and accept the', 'yit' ); ?> <a href="<?php echo esc_url( get_permalink(woocommerce_get_page_id('terms')) ); ?>" target="_blank"><?php _e( 'terms &amp; conditions', 'yit' ); ?></a></label>
