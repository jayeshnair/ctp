...
// FORCE TO DELETE THE SIDEBAR WITH SMALL-IMAGE LAYOUT
global $yit_sidebar_layout;
if($blog_type=='small-image'): $yit_sidebar_layout['layout']= "sidebar-no"; endif;

// IF BLOG TYPE IS PINTEREST
...
<div id="primary" class="<?php yit_sidebar_layout() ?>">
    <div class="container group">
	    <div class="row">
	        ...
	        <!-- START CONTENT -->
            <?php
            if( $blog_type == 'small-image' ){
                $yit_this_class= "   blog  small-image";
            }else{
                if(yit_get_sidebar_layout() == 'sidebar-no'){
                    $yit_this_class= " span12 ";
                }else{
                    $yit_this_class= " span9 ";
                }
            ...
            <div id="content-blog" class="<?php  echo $yit_this_class;  ?> content group">
