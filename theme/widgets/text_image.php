...
class text_image extends WP_Widget
{
    ...
    function widget( $args, $instance ) {
        ...
        if( function_exists( 'icl_translate' ) ) {
            $clear_text = icl_translate( 'Widgets', 'widget_text_image' . sanitize_title( $instance['text'] ), $instance['text'] );
        } else {
            $clear_text = apply_filters( 'widget_text', $instance['text'], $instance );
        }
