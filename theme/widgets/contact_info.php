...
class contact_info extends WP_Widget
{
	...
	function form( $instance )
	{
        ...
        <p>
            <label><?php _e( 'Customer support number', 'yit' ) ?>:
	...
	function widget( $args, $instance )
	{
		...
		$text .= '  <ul>';
            ...
            $text .= ( !empty( $instance['email'] ) ) ? '<li>' . $email_image . '<strong>' . __( 'Mail address', 'yit' ) . '</strong> ' . do_shortcode( $instance['email'] ) . '</li>' : '';
            $text .= ( !empty( $instance['phone'] ) ) ? '<li>' . $phone_image . '<strong>' . __( 'Customer support', 'yit' ) . '</strong> ' . do_shortcode( $instance['phone'] ) . '</li>' : '';
		$text .= '  </ul>';
		$text .= '</div>'; 
