...
class YIT_Widget_Best_Sellers extends WP_Widget {
	...
	function YIT_Widget_Best_Sellers() {
		...
		$this->woo_widget_description = __( 'Display a list of your best selling products on your site.', 'yit' );
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('hide_free'); ?>"><?php _e( 'Hide free products', 'yit' ); ?></label></p>
