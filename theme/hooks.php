...
add_action( 'yit_after_header', 'yit_slogan', 20 );
...
add_action( 'yit_after_header', 'yit_map', 10 );
...
add_filter( 'wp_nav_menu_items', 'yit_wpml_nav_menu', 101 );
add_filter( 'wp_nav_menu_items', 'yit_myaccount_nav_menu', 102 );
...
add_action( 'comment_form_before_fields', create_function( '', 'if ( ! function_exists("is_product") || ! is_product() ) { echo "<div class=\"span9 fields\">"; }' ) );

add_action( 'comment_form_after_fields', create_function( '', 'if ( ! function_exists("is_product") || ! is_product() ) echo "<div class=\" clearfix \"></div></div>";' ) );
...
/* === MENU */
add_filter( 'yit_walker_nav_menu_title', 'yit_walker_nav_menu_title', 10);