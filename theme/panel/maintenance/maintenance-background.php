...
function yit_maintenance_bg_image_std( $std ) {
    return YIT_IMAGES_URL . '/backgrounds/splash/02.jpg';
}
add_filter( 'yit_maintenance-bg_image_std', 'yit_maintenance_bg_image_std' );
