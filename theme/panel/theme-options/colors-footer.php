...
function yit_submenu_tabs_theme_option_colors_footer( $items ) {
    ...
    unset( $items[10], $items[20], $items[30] );
        ...
        $items[55] = array(
            ...
            'desc' => __( 'Select the color for all the borders in the footer.', 'yit' ),
            'std' => apply_filters( 'yit_footer-borders-color_std', '#d0d0d0' ),
            'style' => array(
				'selectors' => '#footer .recent-post .thumb-img img, #footer .widget ul li a:hover,  #footer #searchform input, #footer .widget_flickrRSS img, #footer .testimonial-widget div.name-testimonial, #footer .last-tweets-widget ul li, #footer .yit-widget-content .widget, #footer .recent-comments .avatar img, #footer .more-projects-widget .work-thumb, #footer .more-projects-widget .controls, #footer .more-projects-widget .top, #footer .featured-projects-widget img, #footer .thumb-project img',
				'properties' => 'border-color'
            )
        );
		$items[65] = array(
			'id' => 'footer-block-border-color',
			'type' => 'colorpicker',
			'name' => __( 'Footer block border color', 'yit' ),
			'desc' => __( 'Select the color for the block border in the footer container.', 'yit' ),
			'std' => apply_filters( 'yit_footer-borders-color_std', '#e8e8e8' ),
			'style' => array(
				'selectors' => '#footer .container .row:after, #footer .row-fluid:after',
				'properties' => 'border-color'
			)
		);
        $items[70] = array(
		...
		$items[110] = array(
                ...
                'std' => apply_filters( 'yit_copyright-borders-color_std', '#d0d0d0' ),
                'style' => apply_filters( 'yit_copyright-borders-color_style', array(
                	'selectors' => '#copyright .container .row-fluid, #copyright .container .row',
                	'properties' => 'border-color'				
            ) )
        );
        return $items;
