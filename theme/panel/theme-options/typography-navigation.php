...
function yit_tab_typography_navigation( $fields ) {
        return array(
            10 => array(
                ...
                'style' => array(
					'selectors' => '#nav ul li, #nav ul li a, #nav ul li a span.special-font, #nav .megamenu ul.sub-menu li.menu-item-custom-content p span.special-font, #header-sidebar .widget_nav_menu li a',
            ...
            11 => array(
                ...
                'std'  => apply_filters( 'yit_navigation-text-font-hover_std', '#ca4b4b' ),
                'style' => array(
					'selectors' => '#nav ul li a:hover, #nav li:hover > a, #nav ul li a:hover span, #nav li:hover > a span, #header-sidebar .widget_nav_menu li a:hover',
					'properties' => 'color'
				)
            ),
            12 => array(
                ...
                'std'  => apply_filters( 'yit_navigation-text-font-active_std', '#ca4b4b' ),
                'style' => array(
					'selectors' => '#nav .current-menu-item > a, #nav .current-menu-ancestor > a, div#nav ul .current_page_item > a, #nav .current_page_ancestor > a, #nav .current-menu-ancestor > a, #nav .current-menu-item > a span, #nav .current-menu-ancestor > a span, div#nav ul .current_page_item > a span, #nav .current_page_ancestor > a span, #nav .current-menu-ancestor > a span, #nav .megamenu ul.sub-menu li.current-menu-item > a ',
					'properties' => 'color'
				)
            ),
            20 => array(
                ...
                'style' => array(
					'selectors' => '#nav ul li ul li a, #nav .megamenu ul.sub-menu li li a, #nav ul li ul li a span.special-font, #nav .megamenu ul.sub-menu li li a span.special-font, #topbar #lang_sel ul ul a, #topbar .widget ul ul a',
					'properties' => 'font-size, font-family, color, font-style, font-weight'
				)
            ),
            21 => array(
                ...
                'std'  => apply_filters( 'yit_sub-navigation-text-font-hover_std', '#ca4b4b' ),
                'style' => array(
					'selectors' => '#nav ul li ul li a:hover, #nav .megamenu ul.sub-menu li li a:hover, #nav ul li ul li a:hover span, #nav .megamenu ul.sub-menu li li a:hover span, #topbar #lang_sel ul ul a:hover, #topbar .widget ul ul a:hover',
					'properties' => 'color'
				)
            ),
            22 => array(
                ...
                'std'  => apply_filters( 'yit_sub-navigation-text-font-active_std', '#ca4b4b' ),
                'style' => array(
