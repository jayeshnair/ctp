...
function yit_add_shortcodes( $shortcodes ) {
	...
	*/
    ...
    $shortcodes['section']['attributes']['enable_slider'] =
    $shortcodes['section_blog']['attributes']['enable_slider'] = array(
    ...
    return array_merge( $shortcodes, array(
        ...
        'testimonials_slider' => array(
        	...
        	'attributes' => array(
                ...
                'title' => array(
                    'title' => __('Slider Title', 'yit'),
                    'description' => __('Select the title of the slider', 'yit'),
                    'type' => 'text',
                    'std'  => 'Happy customers'
                ),
        	)
            	...
            	'attributes' => array(
            		...
            		'icon_type' => array(
            			...
            			'options' => array(
                            ...
                            'round' => __('Round', 'yit'),
                            'simple-black' => __('Simple Black', 'yit'),
                            'simple-white' => __('Simple White', 'yit'),
						),
            			'std'  => 'default'
            		),
            		'size' => array(
        ...
        /* === CALL TO ACTION 4 === */
        'call_four' => array(
            'title' => __('Call to action with banner button', 'yit' ),
            ...
            'attributes' => array(
                ...
                'subslogan' => array(
                    ...
                    'type' => 'text', // btn-view-over-the-town-1|btn-the-bizzniss-1|btn-french-1|ecc
                    'std'  => ''
                ),
                'hover_color' => array(
                    'title' => __('Hover Color', 'yit'),
                    'type' => 'colorpicker',
                    'std'  => '#000000'
                ),
            )
