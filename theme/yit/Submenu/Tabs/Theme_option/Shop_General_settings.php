...
class YIT_Submenu_Tabs_Theme_option_Shop_General_settings extends YIT_Submenu_Tabs_Abstract {
    ...
    public function init() {
        return array(
            ...
            93 => array(
                'id'   => 'shop-checkout-slogan-breadcrumb',
                'type' => 'onoff',
                'name' => __( 'Enable a payment process breadcrumb', 'yit' ),
                'desc' => __( 'Choose if you want to enable a checkout breadcrumb instead of a classic slogan.', 'yit' ),
                'std'  => 1,
            ),
            /*95 => array(
