    ...
    public function init() {
        return array(
            ...
            65 => array(
                ...
                'type' => 'onoff',
                'name' => __( 'Force uppercase in the titles', 'yit' ),
                'desc' => __( 'Say if you want the produc titles in uppercase.', 'yit' ),
                'std'  => true,
            ),
            70 => array(
            ...
            210 => array(
                ...
                'desc' => __( 'Say if you want to show the link for sharing product.', 'yit' ),
