...
<link rel="stylesheet" type="text/css" media="all" href="<?php echo yit_ssl_url( YIT_CORE_ASSETS_URL ) . '/css/reset-bootstrap.css'; ?>" />
...
//owl slider
wp_register_script( 'owl-carousel', get_template_directory_uri() .'/theme/assets/js/owl.carousel.min.js' );

//swiper slider
wp_register_script( 'owl-swiper', get_template_directory_uri() .'/theme/assets/js/idangerous.swiper.js' );
