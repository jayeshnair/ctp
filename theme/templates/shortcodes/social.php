...
<?php if( $icon_type == 'round' || $icon_type == 'fade') : ?>
...
<a href="<?php echo $href; ?>" class="socials-default<?php echo $size . ' ' . $icon_type .' ' . $type; ?>" <?php echo $target; ?>><?php echo $type; ?></a>
    ...
    <?php /** icon social simple Black **/ ?>
    <?php elseif( $icon_type == 'simple-black' ) : ?>
<div class="socials-simple-black<?php echo $size .' ' . $type . $size . ' ' . $icon_type; ?>">
    <a href="<?php echo $href; ?>" class="socials-simple-black<?php echo $size . ' ' . $icon_type .' ' . $type; ?>" <?php echo $target; ?>></a>
</div>
<?php /** icon social simple White **/ ?>
    <?php elseif( $icon_type == 'simple-white' ) : ?>
<div class="socials-simple-white<?php echo $size .' ' . $type . $size . ' ' . $icon_type; ?>">
    <a href="<?php echo $href; ?>" class="socials-simple-white<?php echo $size . ' ' . $icon_type .' ' . $type; ?>" <?php echo $target; ?>></a>
</div>
<?php endif ?>