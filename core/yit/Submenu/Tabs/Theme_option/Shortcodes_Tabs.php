...
class YIT_Submenu_Tabs_Theme_option_Shortcodes_Tabs extends YIT_Submenu_Tabs_Abstract {
    ...
    public function init() {  
        return array(
            ...
            120 => array(
                'id'   => 'prices-large-table-text',
                'type' => 'typography',
                'name' => __( 'Featured price table text', 'yit' ),
                'desc' => __( 'Choose the font type, size and color for the text.', 'yit' ),
                'min'  => 1,
                'max'  => 30,
                'std'  => apply_filters( 'yit_prices-large-table-text_std', array(
                    'size'   => 15,
                    'unit'   => 'px',
                    'family' => 'Lato',
                    'style'  => 'regular',
                ...
                'style' => apply_filters('yit_prices-table-text_style',array(
                    'selectors' => '.pricing_box.large, .pricing_box.large p, .pricing_box.large ul li',
                    'properties' => 'font-size, font-family, color, font-style, font-weight'
                ))
            ),
        );
