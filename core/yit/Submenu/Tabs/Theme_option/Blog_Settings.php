...
class YIT_Submenu_Tabs_Theme_option_Blog_Settings extends YIT_Submenu_Tabs_Abstract {
    ...
    public function init() {  
        return array(
            ...
            67 => array(
                'id'   => 'list-blog-show-excerpt',
                'type' => 'onoff',
                'name' => __( 'Show the excerpt on single post\'s list page', 'yit' ),
                'desc' => __( 'Select if you want to show  the excerpt when you are on single post\'s list page.', 'yit' ),
                'std'  => apply_filters( 'yit_list-blog-show-subtitle', 1 )
            ),
            68 => array(
                'id'   => 'list-blog-show-subtitle',
                'type' => 'onoff',
                'name' => __( 'Show the subtitle on single post\'s list page', 'yit' ),
                'desc' => __( 'Select if you want to show  the subtitle when you are on single post\'s list page.', 'yit' ),
                'std'  => apply_filters( 'yit_list-blog-show-subtitle', 0 )
            ),
            69 => array(
                'id'   => 'blog-show-subtitle',
                'type' => 'onoff',
                'name' => __( 'Show subtitle on single post', 'yit' ),
                'desc' => __( 'Select if you want to show the subtitle when you are in single page.', 'yit' ),
                'std'  => apply_filters( 'yit_blog-show-subtitle', 1 )
            ),
            70 => array(
                'id'   => 'blog-show-date',
                'type' => 'onoff',
