...
//Enabled image border in widgets
if( !yit_get_option('remove-sidebar-image-border') ) {
    $body_classes .= ' yit_widget_border_image';
}
...
<!-- START HEAD -->
<head>
    <meta name="google-site-verification" content="ey4Cu83qZGgvPWUmYksnuElFyJ4Zvj67j7Q2SBwdtCU" />
