...
<form  action="<?php echo $product->get_permalink() ?>" class="variations_form cart" method="post" enctype='multipart/form-data' data-product_id="<?php echo $post->ID; ?>" data-product_variations="<?php echo esc_attr( json_encode( $available_variations ) ) ?>" data-wccl="true">
    ...
    <div class="clearfix"></div>
        ...
        <div class="single_variation_wrap" style="display:none;">
            ...
            <div class="variations_button group">
                ...
                <?php //do_action('woocommerce_before_add_to_cart_button'); ?>
                <button type="submit" class="single_add_to_cart_button button alt"><?php echo apply_filters( 'add_to_cart_text' , $product->single_add_to_cart_text() ); ?></button>
            </div>
